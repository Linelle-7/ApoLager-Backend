...
public class Main {
    public static void main(String[] args) {
        ...
        service.increaseCount("04324188", 100, new Ablaufdatum(2026, 5, 1));
        service.increaseCount("04324188", 50,new Ablaufdatum(2026, 12, 31));
        service.increaseCount("01126111", 200, new Ablaufdatum(2027, 1, 1));
        System.out.println(service.printLager());
